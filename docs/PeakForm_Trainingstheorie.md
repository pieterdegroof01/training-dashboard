...
PeakForm hanteert niet één vaste verdeling voor iedereen. Welke verdeling van toepassing is hangt af van tijdsbudget, niveau, doeltype en discipline; de sectie Intensiteitsverdeling en periodisering per atleetsituatie verderop in dit document is de normatieve plek waar die assen en de bijbehorende banden staan. Wanneer die sectie voor een atleetsituatie een pyramidale verdeling aanwijst — bij een gematigd tijdsbudget is dat het gangbare profiel — hanteert PeakForm daarbinnen de volgende streefverdeling per fase, voor het pyramidale profiel:
...
Deze percentages zijn uitgedrukt in tijd, niet in sessiefrequentie, en gelden specifiek voor het pyramidale profiel. Polarized- en sweetspot-profielen volgen hun eigen basisverdeling, verschoven door dezelfde doeltype- en faselogica; die banden zijn hier bewust niet uitgeschreven om geen tweede matrix naast de sectie Intensiteitsverdeling en periodisering per atleetsituatie te laten ontstaan.
